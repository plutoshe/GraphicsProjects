...
static void OnKeyboard(unsigned char Key, int x, int y) {
	s_pCallbacks->OnKeyboard(Key, x, y);
}
static void MouseAction(int button, int state, int x, int y) {
	s_pCallbacks->MouseAction(button, state, x, y);
}
static void PassiveMouseDuringAction(int x, int y) {
	s_pCallbacks->PassiveMouseDuringAction(x, y);
}
static void InitializeGlutCallbacks()
{
	...
	glutMotionFunc(PassiveMouseDuringAction);
